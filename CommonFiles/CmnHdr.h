...
template <class TV, class TM> inline TV chROUNDDOWN(TV Value, TM Multiple) {
  return ((Value / Multiple) * Multiple);
}

// This inline function rounds a value down to the nearest multiple
template <class TV, class TM> inline TV chROUNDUP(TV Value, TM Multiple) {
...
#define chBEGINTHREADEX(psa, cbStackSize, pfnStartAddr, pvParam,               \
                        dwCreateFlags, pdwThreadId)                            \
  ((HANDLE)_beginthreadex((void *)(psa), (unsigned)(cbStackSize),              \
...
#pragma comment(                                                               \
        linker,                                                                \
            "/manifestdependency:\"type='win32' name='Microsoft.Windows.Common-Controls' version='6.0.6000.0' processorArchitecture='amd64' publicKeyToken='6595b64144ccf1df' language='*'\"")
#endif
#if defined(M_IX86)
#pragma comment(                                                               \
        linker,                                                                \
